    ...
    startWithStateTransitions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.connectionState = HubConnectionState.Disconnected;
                this.logger.log(ILogger_1.LogLevel.Debug, `HubConnection failed to start successfully because of error '${e}'.`);
    ...
    startInternal() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger.log(ILogger_1.LogLevel.Debug, `Hub handshake failed with error '${e}' during start(). Stopping HubConnection.`);
                this.cleanupTimeout();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (nextRetryDelay !== null) {
                ...
                try {
                    ...
                    this.logger.log(ILogger_1.LogLevel.Information, `Reconnect attempt failed because of error '${e}'.`);
                    if (this.connectionState !== HubConnectionState.Reconnecting) {
